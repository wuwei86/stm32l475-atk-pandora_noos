...
void lv_port_disp_init(void)
{
    ...
    static lv_color_t buf_1[SCREEN_WIDTH * 10];                          /*A buffer for 10 rows*/
    lv_disp_draw_buf_init(&draw_buf_dsc_1, buf_1, NULL, SCREEN_WIDTH * 10);   /*Initialize the display buffer*/
#if 0
    /* Example for 2) */
